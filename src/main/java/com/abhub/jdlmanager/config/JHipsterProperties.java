...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jdlManager@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jdlManager API";

        private String description = "jdlManager API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jdlManager";
